...
<div class="body-wrapper">
  ...
  <div class="dark-wrapper offset">
    <div class="section-head">
      <div class="container">
        <h1>Economic and Financial Affairs Council (ECOFIN)</h1>
      </div>
      <!-- /.container --> 
    </div>
    <!-- /.section-head -->
    <div class="container inner">
        ...
        <div class="span6">
          ...
          <div id="myTabContent" class="tab-content box">
            ...
            <div class="tab-pane fade" id="tab2">
              <p>To view country matrices, <a href="https://docs.google.com/spreadsheets/d/1Scv1RxldGgCLd5y7JkrbUn0mxgk8m1-ZeVqZX9XboA0/edit?usp=sharing" target="_blank">click here</a>.</P>
            </div>
            <!-- /.tab-pane -->
          ...
          <div class="accordion" id="accordion">
            <div class="accordion-group">
              ...
              <div id="collapseOne" class="accordion-body collapse in">
                <div class="accordion-inner"> 200-300 delegates </div>
              </div>
            </div>
            <!-- /.accordion-group -->
            <div class="accordion-group">
              ...
              <div id="collapseTwo" class="accordion-body collapse">
                <div class="accordion-inner">BEGINNERS</div>
              </div>
            </div>
            <!-- /.accordion-group -->
            <div class="accordion-group">
              ...
              <div id="collapseThree" class="accordion-body collapse">
                <div class="accordion-inner"> Financial stability towards the economically backward nations in lieu of sustainable development goals.</div>
              </div>
            </div>
            <!-- /.accordion-group --> 
          </div>
      ...
      <div class="row"><!--
      <div class="span4">
	  <img src="style/images/CCC/ccc1.png">
	  </div>
	  <div class="span4">
	  <img src="style/images/CCC/ccc2.png">
	  </div>
	  <div class="span4">
	  <img src="style/images/CCC/ccc3.png">
	  </div>-->
	  </div>
	  </div>
	  <hr />
