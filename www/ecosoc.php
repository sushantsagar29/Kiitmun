...
<div class="body-wrapper">
  ...
  <div class="dark-wrapper offset">
    <div class="section-head">
      <div class="container">
        <h1>Economic & Social Council (ECOSOC)</h1>
      </div>
      <!-- /.container --> 
    </div>
    <!-- /.section-head -->
    <div class="container inner">
        ...
        <div class="span6">
          ...
          <div id="myTabContent" class="tab-content box">
            <div class="tab-pane fade in active" id="tab1">
             <p>ECOSOC, one of the six main organs of the United Nations established by the UN Charter in 1946, is the principal body for coordination, policy reviews, policy dialogue and recommendations on economic, social and environmental issues, as  well as for implementation of the internationally agreed development goals.</p>
			<p>ECOSOC serves as the central mechanism for the activities of the United Nations system and its specialised agencies, and supervises the subsidiary and expert bodies in the economic, social and environmental fields.</p>
			<p>ECOSOC has undergone reforms(A/RES/61/16 , A/RES/68/1)in the last decade to strengthen the Council and its working methods, giving special attention to the integrated and coordinated implementation of, and follow up to , the outcomes of all major United Nations conference summits in the economic , social, environmental and related issues.</p>
          </div>
            <!-- /.tab-pane -->
          ...
          <div class="accordion" id="accordion">
            <div class="accordion-group">
              ...
              <div id="collapseOne" class="accordion-body collapse in">
                <div class="accordion-inner"> 60 delegates </div>
              </div>
            </div>
            <!-- /.accordion-group -->
            <div class="accordion-group">
              ...
              <div id="collapseTwo" class="accordion-body collapse">
                <div class="accordion-inner"> INTERMEDIATE</div>
              </div>
            </div>
            <!-- /.accordion-group -->
            <div class="accordion-group">
      ...
      <div class="row">
      <div class="span4">
	  <img src="style/images/ECOSOC/ecosoc1.png">
	  </div>
	  <div class="span4">
	  <img src="style/images/ECOSOC/ecosoc2.png">
	  </div>
	  <div class="span4">
	  <img src="style/images/ECOSOC/ecosoc3.png">
	  </div>
	  </div>
	  </div>
	  <hr />
