...
<div class="body-wrapper">
  ...
  <div class="dark-wrapper offset">
    <div class="section-head">
      <div class="container">
        <h1>United Nations Educational Social & Cultural Organization (UNESCO)</h1>
      </div>
      <!-- /.container --> 
    </div>
    <!-- /.section-head -->
        ...
        <div class="span6">
          ...
          <div id="myTabContent" class="tab-content box">
            <div class="tab-pane fade in active" id="tab1">
             <p>1945, UNESCO was created in order to respond to the firm belief of nations , forged by  the two world wars in less than a generation  ,that political and economic agreements are not enough to build a lasting peace. Peace must be established on the basis of humanity's moral and intellectual solidarity.</p>
			 <p>UNESCO strives to build networks among nations that enable this kind of solidarity.</p>
            </div>
            <!-- /.tab-pane -->
          ...
          <div class="accordion" id="accordion">
            <div class="accordion-group">
              ...
              <div id="collapseOne" class="accordion-body collapse in">
                <div class="accordion-inner"> 100-130 delegates  (DOUBLE DELEGATIONS ALLOWED) </div>
              </div>
            </div>
            <!-- /.accordion-group -->
            <div class="accordion-group">
	...
	<div class="row">
	  ...
	  <div class="span3">
	  <img src="style/images/UNESCO/unesco1.png">
	  </div>
      <div class="span3">
	  <img src="style/images/UNESCO/unesco2.png">
	  </div>
	    
	   
	  <div class="span3">
	  <img src="style/images/UNESCO/unesco3.png">
	  </div>
      <div class="span3">
	  <img src="style/images/UNESCO/unesco4.png">
	  </div>
	  </div>
