...
<meta name="author" content="Prashant | Sushant">
...
<div class="body-wrapper">
  ...
  <div class="dark-wrapper offset">
    <div class="section-head">
      <div class="container">
        <h1>United Nations General Assembly &#45; DISEC</h1>
      </div>
      <!-- /.container --> 
    </div>
    <!-- /.section-head -->
    <div class="container inner">
      <div class="row">
        <div class="span6">
          ...
          <ul id="myTab" class="nav nav-tabs bm0">
            ...
            <li><a href="#tab2" data-toggle="tab">Country Matrix</a></li>
          </ul>
          <!-- /.nav-tabs -->
          <div id="myTabContent" class="tab-content box">
            <div class="tab-pane fade in active" id="tab1">
             <p> The Fourth Committee of the UN General Assembly, SPECPOL ( also known as Special Political and Decolonisation Committee), is one of six committees of UN, consisting of all UN members. After the dismantling of the trusteeship system resulting from independence being granted to all the trust territories, and the now limited number of non-self-governing territories, that jurisdiction is insufficient to keep the committee occupied. Consequently, it was merged with the Special Political Committee(which had been created as seventh committee of the whole) to deal with certain political issues after the General Assembly found that the First Committee ,Disarmament and Political, was too busy.</p>
			 <p> This Committee deals with decolonisation, Palestinian refugees and human rights, peacekeeping, mine action, outer space, public information, atomic radiation and the University for Peace.</p>

            </div>
            <!-- /.tab-pane -->
            <div class="tab-pane fade" id="tab2">
              <p>To be released soon. Stay tuned.</P>
            </div>
            <!-- /.tab-pane -->
        ...
        <div class="span6">
          ...
          <div class="accordion" id="accordion">
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne"> Committee Strength </a> </div>
              <div id="collapseOne" class="accordion-body collapse in">
                <div class="accordion-inner"> 100-150 delegates (DOUBLE DELEGATIONS ALLOWED) </div>
              </div>
            </div>
            <!-- /.accordion-group -->
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"> Committee Level </a> </div>
              <div id="collapseTwo" class="accordion-body collapse">
                <div class="accordion-inner"> INTERMEDIATE COMMITTEE</div>
              </div>
            </div>
            <!-- /.accordion-group -->
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseThree"> Agenda </a> </div>
              <div id="collapseThree" class="accordion-body collapse">
                <div class="accordion-inner"> To be announced.</div>
              </div>
            </div>
            <!-- /.accordion-group --> 
          </div>
      ...
      <hr />
       <div class="row">
	  <div class="span4">
	  <img src="style/images/specpol/specpol1.png">
	  </div>
      <div class="span4">
	  <img src="style/images/specpol/specpol2.png">
	  </div>
	  <div class="span4">
	  <img src="style/images/specpol/specpol3.png">
	  </div>
	  </div>
	  </div>
	  <hr />
 <footer class="light-wrapper text-center">
    <div class="container inner">
      <p>Copyright &copy; KIIT International MUN 2015 | All rights reserved.<br>Developed by: KIIT MUN Web Team</p>
