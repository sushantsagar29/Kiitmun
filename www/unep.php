...
<div class="body-wrapper">
  ...
  <div class="dark-wrapper offset">
    <div class="section-head">
      <div class="container">
        <h1>United Nations Environment Programme (UNEP)</h1>
      </div>
      <!-- /.container --> 
    </div>
    <!-- /.section-head -->
    <div class="container inner">
        ...
        <div class="span6">
          ...
          <div id="myTabContent" class="tab-content box">
            <div class="tab-pane fade in active" id="tab1">
              <p>UNEP is the leading global environmental authority that sets the global environmental agenda, promotes the coherent implementation of the environmental agendas, sustainable development within the United Nations system and serves as an authoritative advocate for the global environment.</p>
			  <p>UNEP work encompasses:<br>
				*Assessing global, regional and national environmental conditions and trends<br>
				*Developing international and national environmental instruments<br>
				*Strengthening institutions for the wise management of the environment<br>
      ...
      <hr />
	   ...
	   <div class="span2"></div>
	  <div class="span4">
	  <img src="style/images/UNEP/unep1.png">
	  </div>
      <div class="span4">
	  <img src="style/images/UNEP/unep2.png">
	  </div>
	  <div class="span2"></div>
	  </div>
	  </div>
