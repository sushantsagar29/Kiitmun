...
<div class="body-wrapper">
  ...
  <div class="dark-wrapper offset">
    ...
    <div class="container inner">
	 <div class="row">
	 <p>If selected as campus ambassador you shall be eligible under the Campus Ambassador Programme to get:</p>
	 
	 <p>100% Rebate in your Registration as Delegate/Press member (Worth 1000 INR) if a minimum of 15 Delegates are referred through you.
		That is, they fill up the form, giving your name in the Campus Ambassador Field.  </p>

	<p><b>The Campus Ambassador with the most referrals shall win the Secretary General's Trophy for the Best Campus Ambassador.</b></p>
	<p><b><u>All Campus Ambassador shall receive certificates.</u></b></p>
	</div><!--/.row--->
	<hr />
	<div class="row">
		<div class="span2"></div>
		...
		<i><center><small>For assistance with the form, get in touch with us on +91-9692549623 or mail us at <a href="mailto:contact@kiitmun.org">contact@kiitmun.org</a></small></center><br />
		</i><form role="form" id="caform"method="POST" action="caappsub.php" autocomplete="true">
			...
			<div class="form-group">
				...
				<input name="altemail" placeholder="Alternate Email Id" type="email" class="form-control"/>
				<br>
				...
				<b>Past Positions of Responsibility held in the Campus</b>
				<textarea name="pastca" placeholder="Past Positions of Responsibility held in the Campus" type="text" class="form-control"></textarea>
