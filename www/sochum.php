...
<div class="body-wrapper">
  ...
  <div class="dark-wrapper offset">
    ...
    <div class="container inner">
        ...
        <div class="span6">
          ...
          <div id="myTabContent" class="tab-content box">
            <div class="tab-pane fade in active" id="tab1">
             <p>The General Assembly allocates to the Third Committee, SOCHUM(SOCIAL, HUMANITARIAN & CULTURAL) , agenda items relating to a range of social, humanitarian affairs and human rights issues that affect people all over the world. An important part of the work of the Committee focuses on the examination of human rights questions, including reports of the special procedures of the Human Rights Council which was established in 2006. The Committee also discusses questions relating to the advancement of women, the protection of children, indigenous issues, the treatment of refugees, the promotion of fundamental freedoms through the elimination of racism and racial discrimination, and the right to self-determination.</p>
			<p>The Committee also addresses important social development questions such as issues related to youth, family, ageing, and persons with disabilities, crime prevention, criminal justice, and international drug control.</p>
          ...
          <div class="accordion" id="accordion">
            ...
            <div class="accordion-group">
              ...
              <div id="collapseTwo" class="accordion-body collapse">
                <div class="accordion-inner"> SCHOOL COMMITTEE</div>
              </div>
            </div>
            <!-- /.accordion-group -->
            <div class="accordion-group">
      ...
      <div class="span4">
	  <img src="style/images/SOCHUM/sochum1.png">
	  </div>
	  <div class="span4">
	  <img src="style/images/SOCHUM/sochum2.png">
	  </div>
	  <div class="span4">
	  <img src="style/images/SOCHUM/sochum3.png">
	  </div>
	  </div>
	  </div>
	  <hr />
