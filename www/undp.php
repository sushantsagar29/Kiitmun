...
<div class="body-wrapper">
  ...
  <div class="dark-wrapper offset">
    <div class="section-head">
      <div class="container">
        <h1>United Nations Development Programme (UNDP)</h1>
      </div>
      <!-- /.container --> 
    </div>
    <!-- /.section-head -->
        ...
        <div class="span6">
          ...
          <div id="myTabContent" class="tab-content box">
            <div class="tab-pane fade in active" id="tab1">
              <p>The United Nations Development Programme (UNDP) is the United Nations' global development network.</p>
<p>Headquartered in New York City, UNDP advocates for change and connects countries to knowledge, experience and resources to help people build a better life. It provides expert advice, training, and grant support to developing countries, with increasing emphasis on assistance to the least developed countries.</p>
<p>The status of UNDP is that of an executive board within the United Nations General Assembly. The UNDP Administrator is the third highest-ranking official of the United Nations after the United Nations Secretary-General and Deputy Secretary-General.</p>
<p>To accomplish the MDGs and encourage global development, UNDP focuses on poverty reduction, HIV/AIDS, democratic governance, energy and environment, social development, and crisis prevention and recovery. UNDP also encourages the protection of human rights and the empowerment of women in all of its programmes. The UNDP Human Development Report Office also publishes an annual Human Development Report (since 1990) to measure and analyse developmental progress. In addition to a global Report, UNDP publishes regional, national, and local Human Development Reports</p>
            </div>
            <!-- /.tab-pane -->
          ...
          <div class="accordion" id="accordion">
            <div class="accordion-group">
              ...
              <div id="collapseOne" class="accordion-body collapse in">
                <div class="accordion-inner"> 80-100 delegates  </div>
              </div>
            </div>
            <!-- /.accordion-group -->
            <div class="accordion-group">
      ...
      <hr />
       <div class="row">
      <div class="span4">
	  <img src="style/images/UNDP/undp1.png">
	  </div>
	  <div class="span4">
	  <img src="style/images/UNDP/undp2.png">
	  </div>
	  <div class="span4">
	  <img src="style/images/UNDP/undp3.png">
	  </div>
	  </div>
	  </div>
	  <hr />
