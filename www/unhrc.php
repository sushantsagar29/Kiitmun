  ...
  <div class="dark-wrapper offset">
    ...
    <div class="container inner">
        ...
        <div class="span6">
          ...
          <div id="myTabContent" class="tab-content box">
            <div class="tab-pane fade in active" id="tab1">
             <p>The Human Rights Council replaced the former United Nations Commission on Human Rights and is  made up of 47 United Nations Member States, which are elected by the UN General Assembly.</p>
			 <p>The HUMAN RIGHTS COUNCIL is an inter-governmental body within the United Nations responsible for strengthening, the promotion and protection of human rights around the globe and for addressing situations of humans rights violation and make recommendations on them. It has the ability to discuss all thematic human rights issues and situations that require its attention throughout the year. It meets at the UN Office at Geneva.</p>
		 </div>
            <!-- /.tab-pane -->
          ...
          <div class="accordion" id="accordion">
            <div class="accordion-group">
              ...
              <div id="collapseOne" class="accordion-body collapse in">
                <div class="accordion-inner"> 70-90 delegates </div>
              </div>
            </div>
            <!-- /.accordion-group -->
            <div class="accordion-group">
              ...
              <div id="collapseTwo" class="accordion-body collapse">
                <div class="accordion-inner">ADVANCED</div>
              </div>
            </div>
            <!-- /.accordion-group -->
            <div class="accordion-group">
      ...
      <hr />
       <div class="row">
	  <div class="span4">
	  <img src="style/images/UNHRC/unhrc1.png">
	  </div>
      <div class="span4">
	  <img src="style/images/UNHRC/unhrc2.png">
	  </div>
	  <div class="span4">
	  <img src="style/images/UNHRC/unhrc3.png">
	  </div>
	  </div>
	  </div>
	  <hr />
