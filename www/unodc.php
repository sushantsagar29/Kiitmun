...
<div class="body-wrapper">
  ...
  <div class="dark-wrapper offset">
    <div class="section-head">
      <div class="container">
        <h1>United Nations Office on Drugs and Crime (UNODC)</h1>
      </div>
      <!-- /.container --> 
    </div>
    <!-- /.section-head -->
        ...
        <div class="span6">
          ...
          <div id="myTabContent" class="tab-content box">
            <div class="tab-pane fade in active" id="tab1">
             <p>UNODC was established to assist the United Nations in better addressing a coordinated, comprehensive response to the interrelated issues of illicit trafficking in and abuse of drugs, crime prevention and criminal justice, international terrorism and political corruption.</p>
			<p>These goals are pursued through these primary functions:</p>
 <p>* Research, guidance and support to governments in the adoption and implementation of various crimes, drugs, terrorism and corruption related conventions, treaties and protocols <br>
*Financial assistance to said governments to face their respective situations and challenges in these fields.<br></p>
<p>The main themes UNODC deals with are:<br>
-Alternative development<br>
-Corruption<br>
-Criminal Justice<br>
-Prison reform and Crime Prevention<br>
-Drug Prevention<br>
-HIV and AIDS: Treatment and care<br>
-Human Trafficking and Migrant Smuggling <br>
-Money Laundering<br>
-Organised crimes<br>
          ...
          <div class="accordion" id="accordion">
            <div class="accordion-group">
              ...
              <div id="collapseOne" class="accordion-body collapse in">
                <div class="accordion-inner"> 100-120 delegates  (DOUBLE DELEGATIONS ALLOWED) </div>
              </div>
            </div>
            <!-- /.accordion-group -->
            <div class="accordion-group">
              ...
              <div id="collapseTwo" class="accordion-body collapse">
                <div class="accordion-inner"> BEGINNER</div>
              </div>
            </div>
            <!-- /.accordion-group -->
            <div class="accordion-group">
      ...
      <hr />
       <div class="row">
	  <div class="span4">
	  <img src="style/images/UNODC/unodc1.png">
	  </div>
      <div class="span4">
	  <img src="style/images/UNODC/unodc2.png">
	  </div>
	  <div class="span4">
	  <img src="style/images/UNODC/unodc3.png">
	  </div>
	  </div>
	  </div>
	  <hr />
