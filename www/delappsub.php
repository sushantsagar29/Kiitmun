...
if($_POST['seconddel'] == "show")
	$secname = ", ".filter_var($_POST['secname'],FILTER_SANITIZE_STRING);
else
	$secname = "";
?>
<!DOCTYPE html>
   ...
   <div class="container inner">
	<div class="row">
		...
		<div class="span8">
				<!-- span of the body -->
				<?php
				echo "<center><b>Thank you ".$name,$secname." for applying at KIIT Intl MUN 2015. Please check you email inbox or spam folder</b></center>";
				?>
		</div>
		<div class="span2"></div>
	 </div><!-- /row-->    
...
<!-- DEMO ONLY -->
<link rel="alternate stylesheet" type="text/css" href="switcher/blue.css" title="kyteblue-color" media="screen" />
<link rel="alternate stylesheet" type="text/css" href="switcher/gray.css" title="kytegray-color" media="screen" />
<link rel="alternate stylesheet" type="text/css" href="switcher/green.css" title="kytegreen-color" media="screen" />
<link rel="alternate stylesheet" type="text/css" href="switcher/navy.css" title="kytenavy-color" media="screen" />
<link rel="alternate stylesheet" type="text/css" href="switcher/orange.css" title="kyteorange-color" media="screen" />
<link rel="alternate stylesheet" type="text/css" href="switcher/pink.css" title="kytepink-color" media="screen" />
<link rel="alternate stylesheet" type="text/css" href="switcher/purple.css" title="kytepurple-color" media="screen" />
<link rel="alternate stylesheet" type="text/css" href="switcher/red.css" title="kytered-color" media="screen" />
