...
<div class="body-wrapper">
  ...
  <div class="dark-wrapper offset">
	...
	<p>The duly signed physical copy of the application form completed in all respect and submitted successfully, is to be submitted at the concerned Indian Visa Application Center (IVAC) or directly to Indian Mission/ Post, on the scheduled date of interview along with the requisite supporting documents. The instructions for filling the form and scheduling the appointment can be seen at Instructions for Online Visa Application. Important technical information for filling online Indian visa application can be referred at Technical Instructions.</p>
	<p>The applicants are also requested to visit website of the Indian Mission concerned for detailed information about Indian visa. You can search Google for “ Indian Embassy _ Your County Name_ “</p>
	<p>The e-Tourist Visa (eTV) functionality is available for following nationals :  Finland, Japan, Luxembourg, New Zealand, Singapore, Cambodia, Vietnam, Philippines, Laos ,Myanmar, and Indonesia.</p>
