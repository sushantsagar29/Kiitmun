...
<div class="body-wrapper">
  ...
  <div class="dark-wrapper offset">
    <div class="section-head">
      <div class="container">
        <h1>International Press Committee</h1>
      </div>
      <!-- /.container --> 
    </div>
    <!-- /.section-head -->
    <div class="container inner">
      <div class="row">
        <div class="span6">
          ...
          <div id="myTabContent" class="tab-content box">
            ...
            <p>The press team will ensure the coverage of the MUN through blogs, social media profiles, e-newsletters and much more! Divided across 13 committees their work will be overlooked by the Heads of Press who will be assisted by the Editor-In-Chief. Each committee shall have an editor with journalists working under them. The Photography-in-Chief will lead the team of photographers from the Press Team</p>
		  </div>
            <!-- /.tab-pane -->
          ...
          <div class="accordion" id="accordion">
            <div class="accordion-group">
              ...
              <div id="collapseOne" class="accordion-body collapse in">
                <div class="accordion-inner"> 130 delegates </div>
              </div>
            </div>
            <!-- /.accordion-group -->
            <div class="accordion-group">
              ...
              <div id="collapseTwo" class="accordion-body collapse">
                <div class="accordion-inner"> Committee</div>
              </div>
            </div>
            <!-- /.accordion-group -->
            <div class="accordion-group">
      ...
      <div class="row">
      <div class="span3">
	  <img src="style/images/Press/press1.png">
	  </div>
	  <div class="span3">
	  <img src="style/images/Press/press2.png">
	  </div>
	   <div class="span3">
	  <img src="style/images/Press/press3.png">
	  </div>
	   <div class="span3">
	  <img src="style/images/Press/press4.png">
	  </div>
	  </div>
