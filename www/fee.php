...
<div class="body-wrapper">
  ...
  <div class="dark-wrapper offset">
    ...
    <div class="container inner">
      ...
      <h1>For Delegates of Indian Origin:</h1>
      <p>Delegate or Press Registration Fees: INR 1,000 each, which will include the delegate kit, entry to all three social events, and dinner on all three nights.</p>
	  <p>Accommodation Fees: INR 800 each, which will include breakfast+lunch (dinner already provided from registration fees) and accommodation of three days and nights.</p>

	  <br>
	  <h1>For Delegates of Foreign Origin:</h1>
	  <p>Delegate or Press Registration Fees: USD 50 each, which will include the delegate kit, entry to all three social events, and dinner on all three nights.</p>
	  <p>Accommodation Fees : INR 25 each, which will include breakfast+lunch (dinner already provided from registration fees) and air conditioned accommodation of three days and nights.</p>
	  <p>Scholarship opportunities for students of foreign origin are available and can be found in the ‘SCHOLARSHIP OPPORTUNITIES’ section in the ‘Information’ tab of our website.</p>
