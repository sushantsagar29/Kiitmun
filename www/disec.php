  ...
  <div class="dark-wrapper offset">
    ...
    <div class="container inner">
        ...
        <div class="span6">
          ...
          <div id="myTabContent" class="tab-content box">
            <div class="tab-pane fade in active" id="tab1">
              <p>The First Committee, DISEC, deals with disarmament , global challenges and threats to peace that affect the international community and seeks out solutions to the challenges in the international security regime.</p>
			  <p>It considers all disarmament and international security matters within the scope of the Charter or relating to the powers and functions of any other organ of the United Nations; the general principles of cooperation in the maintenance of international peace and security, as well as principles governing disarmament and regulation of armaments; promotion of cooperative arrangements and measures aimed at strengthening stability through lower levels of armaments.<br>
			  <p>The Committee works in close cooperation with the United nations Disarmament Commission and the Geneva-based Conference on Disarmament. It is the only main Committee of the General Assembly entitled to verbatim records coverage.</p>
			  <p>The First Committee sessions are structured into three distinctive stages:</p>
				*General debate<br>
      ...
      <hr />
       <div class="row">
	  <div class="span4">
	  <img src="style/images/disec/disec1.png">
	  </div>
      <div class="span4">
	  <img src="style/images/disec/disec2.png">
	  </div>
	  <div class="span4">
	  <img src="style/images/disec/disec3.png">
	  </div>
	  </div>
	  </div>
	  <hr />
