...
<div class="body-wrapper">
  ...
  <div class="dark-wrapper offset">
	...
	<div class="span3"></div>
	<div class="span6">
	<form role="form" method="POST" id="adminform" action="portal.php" autocomplete="true">
		<div class="form-group">
					<div id="message"></div><br/>
					<label>News</label>
					<Textarea class="form-control" name="news" placeholder="News" required></textarea>
					<br>
					<label>Author</label>
					...
					<br><br>
					<button type="submit" id="submitover" class="btn btn-success">Update news</button>
...
$(document).ready(function(){ 
 ...
 $('#submitover').click(function(){
	...
	success: function(responseData, textStatus , jqXHR){if(responseData == "OK") {$('form').submit();} else{$('#message').html(responseData);}},
